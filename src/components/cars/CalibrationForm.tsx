...
const sections: { title: string; fields: FieldDef[] }[] = [
  ...
  },
  {
    ...
    fields: [
      { key: "frontRideHeight", label: "Front Ride Height", type: "number", min: 0, max: 50, step: 0.5, unit: "mm" },
      { key: "rearRideHeight", label: "Rear Ride Height", type: "number", min: 0, max: 50, step: 0.5, unit: "mm" },
      ...
      { key: "frontOilWeight", label: "Front Oil Weight / Thickness", type: "text", placeholder: "e.g. 350cSt / 30wt" },
      { key: "rearOilWeight", label: "Rear Oil Weight / Thickness", type: "text", placeholder: "e.g. 300cSt / 25wt" },
      { key: "frontOilBrand", label: "Front Oil Brand / Type", type: "text", placeholder: "e.g. Yokomo Silicone" },
      { key: "rearOilBrand", label: "Rear Oil Brand / Type", type: "text", placeholder: "e.g. Yokomo Silicone" },
      { key: "frontPistonHoles", label: "Front Piston Holes", type: "number", min: 0, max: 20, step: 1 },
      { key: "rearPistonHoles", label: "Rear Piston Holes", type: "number", min: 0, max: 20, step: 1 },
      { key: "frontPistonHoleSize", label: "Front Piston Hole Size", type: "text", placeholder: "e.g. 1.2mm" },
      { key: "rearPistonHoleSize", label: "Rear Piston Hole Size", type: "text", placeholder: "e.g. 1.2mm" },
      { key: "frontShockLength", label: "Front Shock Length", type: "number", min: 0, max: 200, step: 0.5, unit: "mm" },
      { key: "rearShockLength", label: "Rear Shock Length", type: "number", min: 0, max: 200, step: 0.5, unit: "mm" },
      { key: "frontShockBrand", label: "Front Shock Brand", type: "text", placeholder: "e.g. Overdose / TRF" },
      { key: "rearShockBrand", label: "Rear Shock Brand", type: "text", placeholder: "e.g. Overdose / TRF" },
      { key: "frontORings", label: "Front O-Rings Used", type: "text", placeholder: "e.g. Muchmore Red" },
      { key: "rearORings", label: "Rear O-Rings Used", type: "text", placeholder: "e.g. Muchmore Red" },
      { key: "frontDroop", label: "Front Droop", type: "number", min: 0, max: 50, step: 0.5, unit: "mm" },
      { key: "rearDroop", label: "Rear Droop", type: "number", min: 0, max: 50, step: 0.5, unit: "mm" },
    ],
  },
  {
    ...
    fields: [
      ...
      { key: "motorPlacement", label: "Motor Placement", type: "text", placeholder: "e.g. High Mount, Rear Low, Mid" },
      { key: "spurGear", label: "Spur Gear", type: "number", min: 0, max: 200, step: 1, unit: "T" },
      { key: "pinionGear", label: "Pinion Gear", type: "number", min: 0, max: 100, step: 1, unit: "T" },
      { key: "finalDriveRatio", label: "Final Drive Ratio (FDR)", type: "number", min: 0, max: 50, step: 0.01 },
      { key: "gyroGain", label: "Gyro Gain", type: "range", min: 0, max: 100, step: 1 },
      { key: "throttleExpo", label: "Throttle Expo", type: "range", min: -100, max: 100, step: 1 },
      { key: "steeringExpo", label: "Steering Expo", type: "range", min: -100, max: 100, step: 1 },
