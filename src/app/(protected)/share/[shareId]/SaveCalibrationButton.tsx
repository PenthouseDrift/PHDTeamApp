  ...
  function handleSave() {
    ...
    startTransition(async () => {
      const data = {
        ...
        frontOilWeight: calibration.frontOilWeight,
        rearOilWeight: calibration.rearOilWeight,
        frontOilBrand: calibration.frontOilBrand,
        rearOilBrand: calibration.rearOilBrand,
        frontPistonHoles: calibration.frontPistonHoles,
        rearPistonHoles: calibration.rearPistonHoles,
        frontPistonHoleSize: calibration.frontPistonHoleSize,
        rearPistonHoleSize: calibration.rearPistonHoleSize,
        frontShockLength: calibration.frontShockLength,
        rearShockLength: calibration.rearShockLength,
        frontShockBrand: calibration.frontShockBrand,
        rearShockBrand: calibration.rearShockBrand,
        frontORings: calibration.frontORings,
        rearORings: calibration.rearORings,
        frontDroop: calibration.frontDroop,
        rearDroop: calibration.rearDroop,
        gyroGain: calibration.gyroGain,
        motorTurns: calibration.motorTurns,
        motorTiming: calibration.motorTiming,
        motorPlacement: calibration.motorPlacement,
        throttleExpo: calibration.throttleExpo,
        steeringExpo: calibration.steeringExpo,
