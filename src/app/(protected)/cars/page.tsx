      ...
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        {cars.length === 0 ? (
          <div className="flex flex-col items-center justify-center rounded-xl bg-white p-12 text-center">
            ...
            <h2 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100">No cars yet</h2>
              ...
              cars.map(async (car) => {
                ...
                return (
                  <Link
                    key={car.carId}
                    href={`/cars/${car.carId}`}
                    className="group overflow-hidden rounded-xl bg-white transition-colors hover:bg-zinc-100"
                  >
                    {/* Thumbnail */}
